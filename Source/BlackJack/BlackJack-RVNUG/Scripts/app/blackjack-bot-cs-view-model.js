function BlackJackBotCsViewModel() {
...
BlackJackBotCsViewModel.prototype.afterLoad = function () {
    if (!this.id()) {
...
BlackJackBotCsViewModel.prototype.getSampleBot = function () {
    var self = this;
...
BlackJackBotCsViewModel.prototype.reset = function () {
    this.javaScriptCode = this.javaScriptCodeDefault;
    this.editor.setValue(this.javaScriptCode);
    this.editor.moveCursorTo(0, 0);
};

BlackJackBotCsViewModel.prototype.putBot = function () {
    var self = this,
        botDto;
